...
export class Hud {
  ...
  // Themed rewarded-ad popup ("Watch Ad" primary + "No Thanks"), matching the
  // portal's rewarded-ad sample popups (e.g. GameDistribution). The reward is
  // only attempted after the user voluntarily chooses to watch.
